...
library(readr)
library(tidyverse)
sinadef <- read_excel("./SINADEF_DATOS_ABIERTOS_26112020.xlsx",
                      col_names = FALSE)
```
...
write.csv(sinadef.nonproc, file.path(paste0("../../sinadef_noexcl_",format(Sys.time(),"%Y%m%d"),".csv")),row.names = F)
saveRDS(sinadef.nonproc,file.path(paste0("../../sinadef_noexcl_",format(Sys.time(),"%Y%m%d"),".Rdata")))
```
